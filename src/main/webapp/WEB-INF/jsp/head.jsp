            ...
            <div class="nav_w3ls">
                <nav>
                    ...
                    <ul class="menu">
                        ...
                        <li class="mr-lg-3 mr-2"><a href="<%=path%>/question">装修推荐</a></li>
                        <li class="mr-lg-3 mr-2"><a href="<%=path%>/articlelist/1">文章与通告</a></li>
                        <li class="mr-lg-3 mr-2"><a href="<%=path%>/firstCase/1">装修档案馆</a></li>
